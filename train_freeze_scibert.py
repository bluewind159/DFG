...
from model.contrast_freeze_scibert import ContrastModel
...
parser.add_argument('--data', type=str, default='WebOfScience_scibert', choices=['WebOfScience_scibert', 'nyt', 'rcv1', ], help='Dataset.')
...
if __name__ == '__main__':
    ...
    model = ContrastModel.from_pretrained("./SciBERT", num_labels=num_class,
    ...
    checkpoint = torch.load('./checkpoints/WebOfScience_scibert-test_SciBERT_10-24/checkpoint_best_macro.pt')
