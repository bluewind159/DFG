...
from model.contrast_freeze_hy_recon import ContrastModel
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('./checkpoints/WebOfScience-disentangle/checkpoint_best_macro.pt')
    print('load base line from two layer graph!!')
    ...
    from get_recons_model_label import get_recons_model
    ...
    for epoch in range(1000):
        ...
        for data, label, idx in pbar:
            ...
            if i % args.update == 0:
                ...
                i = 0
                loss = 0
            recons_result=model_recons(output['neg_temp'].detach(),output['target'].detach(),output['embeddings'].detach())
