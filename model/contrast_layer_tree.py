...
class ContrastModel(BertPreTrainedModel):
    def __init__(self, config, cls_loss=True, contrast_loss=True, graph=False, layer=1, data_path=None,
        ...
        print('Use the Layer Tree method !!!!!!!!')
        self.lamb = lamb
    ...
    def forward(
            ...
            if adv_trans is not None:
                ...
                for layer in adv_trans:
                    if 'Linear' in str(layer):
                        ...
                        break
                disen_loss=0
                flag=torch.zeros(self.num_class)
                ...
                recons_target=torch.cat(recons_target,dim=1)
                ...
                recons_loss=nn.MSELoss()(recons_result,recons_target.detach())
        ...
        return {
            ...
            'logits_split': logits_split.squeeze(-1),
