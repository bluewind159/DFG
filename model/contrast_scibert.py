...
import numpy as np
from .graph_scibert import GraphEncoder
from .graph_split_scibert import GraphEncoder as GraphSplitEncoder
...
class ContrastModel(BertPreTrainedModel):
    def __init__(self, config, cls_loss=True, contrast_loss=True, graph=False, layer=1, data_path=None,
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('./SciBERT')
        self.dropout = nn.Dropout(config.hidden_dropout_prob)
