...
parser.add_argument('--data', type=str, default='BGC', choices=['WebOfScience', 'BGC', 'DBpedia', 'rcv1'], help='Dataset.')
...
if __name__ == '__main__':
    ...
    save_recons = Saver(model_recons, optimizer_recons, None, args)
    best_score_macro = 0
    best_score_micro = 0
    early_stop_count = 0
    ...
    for epoch in range(1000):
        ...
        if macro_f1 > best_score_macro:
            ...
            save_recons(macro_f1, best_score_macro, os.path.join('checkpoints', args.name, 'checkpoint_best_macro_recons.pt'))
            early_stop_count = 0
        ...
        if micro_f1 > best_score_micro:
            ...
            save_recons(micro_f1, best_score_micro, os.path.join('checkpoints', args.name, 'checkpoint_best_micro_recons.pt'))
            early_stop_count = 0
        print(best_score_macro, best_score_micro)
    log_file.close()
