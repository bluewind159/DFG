...
from model.contrast_freeze_part import ContrastModel
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('./checkpoints/rcv1-origin_model/checkpoint_best_macro.pt')
    ...
    from get_recons_model_part import get_recons_model
