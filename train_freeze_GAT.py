...
from model.contrast_freeze_GAT import ContrastModel
...
if __name__ == '__main__':
    ...
    checkpoint_path = './checkpoints/rcv1-test_more_dropout/checkpoint_best_macro.pt'
    checkpoint = torch.load(checkpoint_path)
    print('load baseline model from:',checkpoint_path)
